...
from electrum_grlc import ecc, constants
from electrum_grlc import bip32
from electrum_grlc.crypto import hash_160
from electrum_grlc.bitcoin import int_to_hex, var_int, is_segwit_script_type, is_b58_address
from electrum_grlc.bip32 import BIP32Node, convert_bip32_intpath_to_strpath
from electrum_grlc.i18n import _
from electrum_grlc.keystore import Hardware_KeyStore
from electrum_grlc.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_grlc.wallet import Standard_Wallet
from electrum_grlc.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_grlc.base_wizard import ScriptTypeNotSupported
from electrum_grlc.logging import get_logger
from electrum_grlc.plugin import runs_in_hwd_thread, Device
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Garlicoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Garlicoin mode")) from e
                raise e
