...
from electrum_grlc.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_grlc.bitcoin import public_key_to_p2pkh
from electrum_grlc.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_grlc import ecc
from electrum_grlc.ecc import msg_magic
from electrum_grlc.wallet import Standard_Wallet
from electrum_grlc import constants
from electrum_grlc.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_grlc.i18n import _
from electrum_grlc.keystore import Hardware_KeyStore
from electrum_grlc.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_grlc.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_grlc.network import Network
from electrum_grlc.logging import get_logger
from electrum_grlc.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-GRLC-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
