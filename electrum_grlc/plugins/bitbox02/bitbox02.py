...
from electrum_grlc import bip32, constants
from electrum_grlc.i18n import _
from electrum_grlc.keystore import Hardware_KeyStore
from electrum_grlc.transaction import PartialTransaction
from electrum_grlc.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from electrum_grlc.util import bh2u, UserFacingException
from electrum_grlc.base_wizard import ScriptTypeNotSupported, BaseWizard
from electrum_grlc.logging import get_logger
from electrum_grlc.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_grlc.simple_config import SimpleConfig
from electrum_grlc.json_db import StoredDict
from electrum_grlc.storage import get_derivation_used_for_hw_device_encryption
from electrum_grlc.bitcoin import OnchainOutputType

import electrum_grlc.bitcoin as bitcoin
import electrum_grlc.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def coin_network_from_electrum_network(self) -> int:
        if constants.net.TESTNET:
            return bitbox02.btc.TGRLC
        return bitbox02.btc.GRLC
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            if coin_network == bitbox02.btc.GRLC:
    ...
    def _get_coin(self):
        return bitbox02.btc.TGRLC if constants.net.TESTNET else bitbox02.btc.GRLC
