...
from electrum_grlc.plugin import hook
from electrum_grlc.i18n import _
from electrum_grlc.util import make_dir, InvalidPassword, UserCancelled
from electrum_grlc.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                      WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_grlc.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_grlc.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_grlc.gui.qt.password_dialog import PasswordDialog
