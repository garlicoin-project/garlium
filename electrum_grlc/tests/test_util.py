...
from electrum_grlc.util import (format_satoshis, format_fee_satoshis, parse_URI,
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('garlicoin:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?label=electrum%20test',
                                {'address': 'LectrumELqJWMECz7W2iarBpT4VvAPqwAv', 'label': 'electrum test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('garlicoin:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?message=electrum%20test',
    ...
    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('garlicoin:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
