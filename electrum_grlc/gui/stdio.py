...
from electrum_grlc.gui import BaseElectrumGui
from electrum_grlc import util
from electrum_grlc import WalletStorage, Wallet
from electrum_grlc.wallet_db import WalletDB
from electrum_grlc.util import format_satoshis
from electrum_grlc.bitcoin import is_address, COIN
from electrum_grlc.transaction import PartialTxOutput
from electrum_grlc.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui(BaseElectrumGui):
    ...
    def __init__(self, *, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-grlc create'")
            exit()
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Garlicoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-grlc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-grlc setconfig' to change your settings")
        return True
