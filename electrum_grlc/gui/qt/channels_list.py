...
from electrum_grlc.util import bh2u, NotEnoughFunds, NoDynamicFeeEstimates
from electrum_grlc.i18n import _
from electrum_grlc.lnchannel import AbstractChannel, PeerState, ChannelBackup, Channel, ChannelState
from electrum_grlc.wallet import Abstract_Wallet
from electrum_grlc.lnutil import LOCAL, REMOTE, format_short_channel_id, LN_MAX_FUNDING_SAT
from electrum_grlc.lnworker import LNWallet
...
class ChannelsList(MyTreeView):
    ...
    def get_toolbar(self):
        ...
        # Garlicoin: disable swap for now
    ...
    def new_channel_dialog(self):
        ...
        if self.parent.network.channel_db:
            ...
            from electrum_grlc.lnworker import hardcoded_trampoline_nodes
