...
from electrum_grlc.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet
from electrum_grlc.wallet import update_password_for_directory

from electrum_grlc.plugin import run_hook
from electrum_grlc import util
from electrum_grlc.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                               format_satoshis, format_satoshis_plain, format_fee_satoshis,
                               maybe_extract_bolt11_invoice, parse_max_spend)
from electrum_grlc.invoices import PR_PAID, PR_FAILED
from electrum_grlc import blockchain
from electrum_grlc.network import Network, TxBroadcastError, BestEffortRequestFailed
from electrum_grlc.interface import PREFERRED_NETWORK_PROTOCOL, ServerAddr
from electrum_grlc.logging import Logger
from electrum_grlc.bitcoin import COIN
...
#Factory.register('InstallWizard', module='electrum_grlc.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_grlc.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_grlc.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_grlc.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_grlc_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_grlc.gui.kivy.uix.screens')
...
from electrum_grlc.util import (NoDynamicFeeEstimates, NotEnoughFunds,
...
if TYPE_CHECKING:
    ...
    from electrum_grlc.plugin import Plugins
...
class ElectrumWindow(App, Logger):
    ...
    def on_qr(self, data: str):
        from electrum_grlc.bitcoin import is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def scan_qr_non_android(self, on_complete):
        from electrum_grlc import qrscanner
        try:
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_grlc.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_grlc.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_grlc_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_grlc_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/electrum-grlc.png"
    ...
    def get_max_amount(self):
        from electrum_grlc.transaction import PartialTxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-GRLC', message,
                            app_icon=icon, app_name='Electrum-GRLC')
        except ImportError:
