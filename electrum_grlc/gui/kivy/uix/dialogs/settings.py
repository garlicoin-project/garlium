...
from electrum_grlc.util import base_units_list
from electrum_grlc.i18n import languages
from electrum_grlc.gui.kivy.i18n import _
from electrum_grlc.plugin import run_hook
from electrum_grlc import coinchooser
...
#:import messages electrum_grlc.gui.messages
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Garlicoin amounts.")
