...
from electrum_grlc.util import print_msg, create_and_start_event_loop
from electrum_grlc.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <garlicoin_address>")
    sys.exit(1)
