...
API_URL_MAINNET = 'https://swaps.electrum-grlc.org/api'
API_URL_TESTNET = 'https://swaps.electrum-grlc.org/testnet'
...
class SwapManager(Logger):
    ...
    async def normal_swap(
        ...
        """send on-chain GRLC, receive on Lightning
    ...
    async def get_pairs(self) -> None:
        ...
        fees = pairs['pairs']['GRLC/GRLC']['fees']
        ...
        limits = pairs['pairs']['GRLC/GRLC']['limits']
