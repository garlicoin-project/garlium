...
$WINE_PYTHON -m pip freeze
wine "$WINE_PYHOME/scripts/pyinstaller.exe" --debug=all --noconfirm --ascii --clean --name $NAME_ROOT-$VERSION -w deterministic.spec
